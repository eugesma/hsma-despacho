...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { description: @sector.description, entry_note_id: @sector.entry_note_id, professional_id: @sector.professional_id, sector_name: @sector.sector_name } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { description: @sector.description, entry_note_id: @sector.entry_note_id, professional_id: @sector.professional_id, sector_name: @sector.sector_name } }
